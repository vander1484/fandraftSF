...
def main():
    ...
    for el in raw.get("elements", []):
        ...
        players.append({
            ...
            "badgeUrl": f"https://resources.premierleague.com/premierleague/badges/70/t{team_code}.png" if team_code else "",
            "photoUrl": f"https://resources.premierleague.com/premierleague/photos/players/110x140/p{code}.png" if code else "",
            "status": status,
